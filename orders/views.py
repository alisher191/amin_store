...
from .serializers import OrderSerializer, DeliverySerializer, FeedbackSerializer
...
class OrderList(ListAPIView):
    ...
    search_fields = ['city', 'street', 'computer__name', 'fullName']
...
class DeliveryList(ListAPIView):
    ...
    search_fields = ['order__city', 'order__street', 'order__computer__name', 'order__fullName']
...
class FeedbackList(ListAPIView):
    ...
    def get_queryset(self):
        computer_id = self.kwargs['product_id']
        return Feedback.objects.filter(computer_id=computer_id)
